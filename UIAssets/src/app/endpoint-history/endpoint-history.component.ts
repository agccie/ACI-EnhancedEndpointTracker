...
export class EndpointHistoryComponent implements OnInit {
    ...
    setupStatusAndInfoStrings() {
        ...
        if (this.endpoint.is_stale) {
            ...
            const currentlyOffsubnet = this.bs.offsubnetStaleEndpointHistory(this.fab,this.vnid,this.address,'is_offsubnet','endpoint') ;
            const currentlyStale = this.bs.offsubnetStaleEndpointHistory(this.fab,this.vnid,this.address,'is_stale','endpoint') ;
            const offsubnetHistory = this.bs.offsubnetStaleEndpointHistory(this.fab,this.vnid,this.address,'is_offsubnet','history') ;
            const staleHistory = this.bs.offsubnetStaleEndpointHistory(this.fab,this.vnid,this.address,'is_stale','history') ;
